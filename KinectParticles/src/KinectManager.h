...
class KinectManager : public ofThread
{
	...
	protected:
		...
		ofPixels				opticalFlowPixelsFullSize;
		Mat						opticalFlowPixelsFullSizeMat;

		ofPixels				opticalFlowPixelsSmallSize;
		Mat						opticalFlowPixelsSmallSizeMat;
		...
		ofImage					maskedColorImageSmallOpticalFlow;
